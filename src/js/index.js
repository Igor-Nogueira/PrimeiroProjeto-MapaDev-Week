/* 
    ...
    -Colocar a classe selecionado no personagem que passamos o moude em cima para adicionar a animação nele
...
personagens.forEach((personagem) => {
    ...
    */
    ...
    imagemJogador1.src = `./src/imagens2/${idSelecionado}.png`
